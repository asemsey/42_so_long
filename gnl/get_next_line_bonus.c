...
/*   Updated: 2024/01/08 14:53:52 by asemsey          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*copy_to_next(char *line)
{
	...
	nextlen = ft_strlen_b(ft_strchr_b(line, '\n'));
	next = ft_substr_b(ft_strchr_b(line, '\n'), 1, nextlen);
	if (!next)
		return (NULL);
	i = 0;
